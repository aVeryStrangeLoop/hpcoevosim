...
# Main function
def get_heterogeneity(filename):
    times = []
    host_hets = []
    para_hets = []
...
def save(times,host_hets,para_hets):
    with open("diversity.csv","w+") as ofile:
...
if __name__=="__main__":
        filename = sys.argv[1]
        times,host_hets,para_hets = get_heterogeneity(filename)
        save(times,host_hets,para_hets)
